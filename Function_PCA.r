...
PCA_plot_outputpdfname <- paste(KEGG_function_txt, ".PCA.pdf", sep="")
pdf( PCA_plot_outputpdfname, width=12, height=14)
ggbiplot(otu.pca, obs.scale = 1, var.scale = 1, groups = sub_design[[category_1]], ellipse = TRUE,var.axes = T)
print(plot)
dev.off()
