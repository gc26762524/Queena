...
organize_deliverable_structure() {
	...
	mkdir Result
	mkdir Result/1-Demux Result/2-OTUAnalysis Result/3-AlphaDiversity Result/4-BetaDiversity Result/5-OTUComparision Result/6-FunctionAnalysis Result/FigureandTable
	...
	ln -s ../3-AlphaDiversity/faith-pd-group-significance.qzv Table3-3.qzv
	...
	ln -s ../3-AlphaDiversity/shannon-group-significance.qzv Figure3-6.qzv
	ln -s ../3-AlphaDiversity/faith-pd-group-significance.qzv Figure3-7.qzv
...
<<COMMENT1
	...
	qiime dada2 denoise-single --i-demultiplexed-seqs demux.qza --p-trim-left 10 --p-trunc-len 180 --o-representative-sequences rep-seqs-dada2.qza --o-table table-dada2.qza  --p-n-threads 0
	...
	##echo "#Differential abundance on different levels"
	##qiime feature-table filter-samples   --i-table table.qza   --m-metadata-file  $mapping_file   --p-where  \"$category_1='$category_3'\" --o-filtered-table ''$category_3'-table.qza'
	##qiime composition add-pseudocount   --i-table ''$category_3'-table.qza'   --o-composition-table 'comp-'$category_3'-table.qza'
	##echo "	qiime composition ancom   --i-table 'comp-'$category_3'-table.qza'  --m-metadata-file  $mapping_file  --m-metadata-category $category_2  --o-visualization 'ancom-'$category_2'.qzv'"
	##qiime composition ancom   --i-table 'comp-'$category_3'-table.qza'  --m-metadata-file  $mapping_file  --m-metadata-category $category_2  --o-visualization 'ancom-'$category_2'.qzv'
	##qiime taxa collapse   --i-table ''$category_3'-table.qza'  --i-taxonomy taxonomy.qza   --p-level 6   --o-collapsed-table ''$category_3'-table-l6.qza'
	##qiime composition add-pseudocount   --i-table ''$category_3'-table-l6.qza'  --o-composition-table 'comp-'$category_3'-table-l6.qza'
	##qiime composition ancom  --i-table 'comp-'$category_3'-table-l6.qza' --m-metadata-file  $mapping_file  --m-metadata-category $category_2 --o-visualization 'l6-ancom-'$category_2'.qzv'
